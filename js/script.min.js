...
function insertEvents(a, b) {
    ...
    /[a-zA-Z]\-[A-Z|0-9][0-9]+/), g = 0; g < b; g++) {
        var h = (a[g][0].substring(a[g][0].search(c.toLocaleString("en", {
            ...
            month: "long"
        }).length, a[g][0].lastIndexOf(",")), document.createElement("div"));
        h.className = "event";
        var i = document.createElement("div");
        i.className = "tab-group";
        ...
        m.innerText = a[g][3];
        var n = document.createElement("a"), o = a[g][3].replace(/ /g, ""), p = a[g][3].split(", ");
        if (1 == p[0].includes("(")) {
            var q = p[0].search("\\("), r = p[0].search("\\)");
            p[0] = p[0].replace(p[0].substr(q - 1, r), "");
        }
        var s = p[0].split(" "), t = !1;
        if (1 == f.test(o)) {
            n.setAttribute("onclick", "closeTab('campusEvents');"), n.setAttribute("href", "#" + f.exec(o)[0].replace("-", "")), 
            n.appendChild(j), n.appendChild(k), n.appendChild(l), n.appendChild(m), h.appendChild(n), 
            i.appendChild(h), 1 == f.exec(o)[0].includes("C-G") ? h.id = "C3" : "C" == f.exec(o)[0].substr(0, 1) && parseInt(f.exec(o)[0].substr(2, 4)) > 1300 && parseInt(f.exec(o)[0].substr(2, 4)) < 2e3 || "C" == f.exec(o)[0].substr(0, 1) && parseInt(f.exec(o)[0].substr(2, 4)) > 2300 && parseInt(f.exec(o)[0].substr(2, 4)) < 3e3 ? h.id = "C3" : h.id = f.exec(o)[0].substr(0, 1);
            var u = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
            u.appendChild(i);
        } else {
            var v, w;
            for (var x in roomNames) for (var y in roomNames[x]) for (var z in roomNames[x][y]) s.length >= 2 && 1 == roomNames[x][y][z].name.includes(s[0].toLowerCase() + "-" + s[1].toLowerCase()) ? (t = !0, 
            v = roomNames[x][y][z].name, w = x.toUpperCase()) : 1 == s.length && 1 == roomNames[x][y][z].name.includes(s[0].toLowerCase()) && (t = !0, 
            v = roomNames[x][y][z].name, w = x.toUpperCase());
            if (1 == t) {
                n.setAttribute("onclick", "closeTab('campusEvents');"), n.setAttribute("href", "#" + v), 
                h.id = w, n.appendChild(j), n.appendChild(k), n.appendChild(l), n.appendChild(m), 
                h.appendChild(n), i.appendChild(h);
                var u = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                u.appendChild(i);
            } else if (p.length > 1 && 1 == p[1].includes("Building") || p.length > 1 && 1 == p[0].includes("Building")) if (1 == p[1].includes("Building")) {
                n.setAttribute("onclick", "closeTab('campusEvents');"), n.setAttribute("href", "#" + p[1].substr(p[1].search("Building") + 9)), 
                h.id = p[1].substr(p[1].search("Building") + 9), n.appendChild(j), n.appendChild(k), 
                n.appendChild(l), n.appendChild(m), h.appendChild(n), i.appendChild(h);
                var u = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                u.appendChild(i);
            } else {
                var A = /[A-Z|0-9][0-9]+/;
                n.setAttribute("onclick", "closeTab('campusEvents');"), n.setAttribute("href", "#" + p[0].substr(p[0].search("Building") + 9) + A.exec(p[1])), 
                h.id = p[0].substr(p[0].search("Building") + 9), n.appendChild(j), n.appendChild(k), 
                n.appendChild(l), n.appendChild(m), h.appendChild(n), i.appendChild(h);
                var u = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                u.appendChild(i);
            } else if (2 == s.length && 1 == s[0].includes("Building") && 1 == s[1].length) {
                n.setAttribute("onclick", "closeTab('campusEvents');"), n.setAttribute("href", "#" + s[1]), 
                h.id = s[1], n.appendChild(j), n.appendChild(k), n.appendChild(l), n.appendChild(m), 
                h.appendChild(n), i.appendChild(h);
                var u = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                u.appendChild(i);
            } else if (1 == a[g][3].includes("Student Center")) {
                n.setAttribute("onclick", "closeTab('campusEvents');"), n.setAttribute("href", "#E"), 
                h.id = "E", n.appendChild(j), n.appendChild(k), n.appendChild(l), n.appendChild(m), 
                h.appendChild(n), i.appendChild(h);
                var u = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                u.appendChild(i);
            } else {
                h.appendChild(j), h.appendChild(k), h.appendChild(l), h.appendChild(m), i.appendChild(h);
                var u = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                u.appendChild(i);
            }
        }
