...
function insertEvents(a, b) {
    ...
    /[a-zA-Z]\-[A-Z|0-9][0-9]+/), g = 0; g < b; g++) {
        ...
        if (h >= c.getDate() && h <= c.getDate() + 14) {
            ...
            n.innerText = a[g][3];
            var o = a[g][3].replace(/ /g, ""), p = a[g][3].split(", ");
            if (1 == p[0].includes("(")) {
            ...
            if (1 == f.test(o)) {
                ...
                u.setAttribute("href", window.location.href.substring(0, window.location.href.search("#") + 1) + f.exec(o)), 
                u.setAttribute("onclick", "closeTab('campusEvents');"), u.appendChild(k), u.appendChild(l), 
                u.appendChild(m), u.appendChild(n), i.appendChild(u), j.appendChild(i), 1 == f.exec(o)[0].includes("C-G") ? i.id = "C3" : "C" == f.exec(o)[0].indexOf(0) && f.exec(o)[0].substr(2, 4) > 1300 && f.exec(o)[0].substr(2, 4) < 2e3 || "C" == f.exec(o)[0].indexOf(0) && f.exec(o)[0].substr(2, 4) > 2300 && f.exec(o)[0].substr(2, 4) < 3e3 ? i.id = "C3" : i.id = f.exec(o)[0].substr(0, 1);
                var v = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                v.appendChild(j);
            } else {
                var w, x;
                for (var y in roomNames) for (var z in roomNames[y]) for (var A in roomNames[y][z]) s.length >= 2 && 1 == roomNames[y][z][A].name.includes(s[0].toLowerCase() + "-" + s[1].toLowerCase()) ? (t = !0, 
                w = roomNames[y][z][A].name, x = y.toUpperCase()) : 1 == s.length && 1 == roomNames[y][z][A].name.includes(s[0].toLowerCase()) && (t = !0, 
                w = roomNames[y][z][A].name, x = y.toUpperCase());
                if (1 == t) {
                    var u = document.createElement("a");
                    u.setAttribute("href", window.location.href.substring(0, window.location.href.search("#") + 1) + w), 
                    u.setAttribute("onclick", "closeTab('campusEvents');"), i.id = x, u.appendChild(k), 
                    u.appendChild(l), u.appendChild(m), u.appendChild(n), i.appendChild(u), j.appendChild(i);
                    var v = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                    v.appendChild(j);
                } else if (p.length > 1 && 1 == p[1].includes("Building")) {
                    var u = document.createElement("a");
                    u.setAttribute("href", window.location.href.substring(0, window.location.href.search("#") + 1) + p[1].substr(p[1].search("Building") + 9)), 
                    i.id = p[1].substr(p[1].search("Building") + 9), u.setAttribute("onclick", "closeTab('campusEvents');"), 
                    u.appendChild(k), u.appendChild(l), u.appendChild(m), u.appendChild(n), i.appendChild(u), 
                    j.appendChild(i);
                    var v = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                    v.appendChild(j);
                } else if (1 == a[g][3].includes("Student Center")) {
                    var u = document.createElement("a");
                    u.setAttribute("href", window.location.href.substring(0, window.location.href.search("#") + 1) + "E"), 
                    i.id = "E", u.setAttribute("onclick", "closeTab('campusEvents');"), u.appendChild(k), 
                    u.appendChild(l), u.appendChild(m), u.appendChild(n), i.appendChild(u), j.appendChild(i);
                    var v = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                    v.appendChild(j);
                } else {
...
function checkLocalStorage() {
    ...
    var a = new Date(), b = (a.getFullYear(), a.getMonth(), localStorage.getObj("event_key")), c = localStorage.getObj("eventNumber_key");
    null == b[0] || 0 == c ? getEvents() : 0 == b[0][0].includes(a.toLocaleString("en", {
        month: "long"
    })) ? getEvents() : insertEvents(b, c);
}
...
>>>>>>> 64c18f5... Bug Fixes
        ...
        var a = /[A-Z][A-Z|0-9][0-9]+/, b = 0;
        if (document.querySelectorAll("h5.no-events")[0].style.display = "none", window.location.hash.length <= 2) {
            for (var c = document.querySelectorAll("div.event"), d = 0; d < c.length; d++) window.location.hash.substr(1) != c[d].id ? (c[d].style.display = "none", 
            ...
            for (var c = document.querySelectorAll("div.event"), d = 0; d < c.length; d++) "C3" == c[d].id ? c[d].style.display = "block" : (c[d].style.display = "none", 
            b++);
            b == c.length && (document.querySelectorAll("h5.no-events")[0].style.display = "block");
        } else {
            for (var c = document.querySelectorAll("div.event"), d = 0; d < c.length; d++) window.location.hash.substr(1, 1) == c[d].id ? c[d].style.display = "block" : (c[d].style.display = "none", 
            b++);
            b == c.length && (document.querySelectorAll("h5.no-events")[0].style.display = "block");
        } else if ("#Campus" == window.location.hash) for (var c = document.querySelectorAll("div.event"), d = 0; d < c.length; d++) c[d].style.display = "block"; else {
            var e;
            ...
            console.log(e));
            for (var b = 0, c = document.querySelectorAll("div.event"), d = 0; d < c.length; d++) c[d].id == e ? (c[d].style.display = "block", 
