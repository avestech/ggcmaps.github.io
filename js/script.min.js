...
function insertEvents(a, b) {
    ...
    /[a-zA-Z]\-[A-Z|0-9][0-9]+/), g = 0; g < b; g++) {
        ...
        if (h >= c.getDate() && h <= c.getDate() + 14) {
            ...
            var t = q[0].split(" "), u = !1;
            if (1 == f.test(p)) {
                o.setAttribute("onclick", "closeTab('campusEvents');"), o.setAttribute("href", "#" + f.exec(p)[0].replace("-", "")), 
                o.appendChild(k), o.appendChild(l), o.appendChild(m), o.appendChild(n), i.appendChild(o), 
                j.appendChild(i), 1 == f.exec(p)[0].includes("C-G") ? i.id = "C3" : "C" == f.exec(p)[0].substr(0, 1) && parseInt(f.exec(p)[0].substr(2, 4)) > 1300 && parseInt(f.exec(p)[0].substr(2, 4)) < 2e3 || "C" == f.exec(p)[0].substr(0, 1) && parseInt(f.exec(p)[0].substr(2, 4)) > 2300 && parseInt(f.exec(p)[0].substr(2, 4)) < 3e3 ? i.id = "C3" : i.id = f.exec(p)[0].substr(0, 1);
                ...
                if (1 == u) {
                    o.setAttribute("onclick", "closeTab('campusEvents');"), o.setAttribute("href", "#" + w), 
                    i.id = x, o.appendChild(k), o.appendChild(l), o.appendChild(m), o.appendChild(n), 
                    i.appendChild(o), j.appendChild(i);
                    var v = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                    v.appendChild(j);
                } else if (q.length > 1 && 1 == q[1].includes("Building") || q.length > 1 && 1 == q[0].includes("Building")) if (1 == q[1].includes("Building")) {
                    o.setAttribute("onclick", "closeTab('campusEvents');"), o.setAttribute("href", "#" + q[1].substr(q[1].search("Building") + 9)), 
                    i.id = q[1].substr(q[1].search("Building") + 9), o.appendChild(k), o.appendChild(l), 
                    o.appendChild(m), o.appendChild(n), i.appendChild(o), j.appendChild(i);
                    var v = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                    v.appendChild(j);
                } else {
                    var B = /[A-Z|0-9][0-9]+/;
                    o.setAttribute("onclick", "closeTab('campusEvents');"), o.setAttribute("href", "#" + q[0].substr(q[0].search("Building") + 9) + B.exec(q[1])), 
                    i.id = q[0].substr(q[0].search("Building") + 9), o.appendChild(k), o.appendChild(l), 
                    o.appendChild(m), o.appendChild(n), i.appendChild(o), j.appendChild(i);
                    var v = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                    v.appendChild(j);
                } else if (2 == t.length && 1 == t[0].includes("Building") && 1 == t[1].length) {
                    o.setAttribute("onclick", "closeTab('campusEvents');"), o.setAttribute("href", "#" + t[1]), 
                    i.id = t[1], o.appendChild(k), o.appendChild(l), o.appendChild(m), o.appendChild(n), 
                    i.appendChild(o), j.appendChild(i);
                    var v = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                    v.appendChild(j);
                } else if (1 == a[g][3].includes("Student Center")) {
                    o.setAttribute("onclick", "closeTab('campusEvents');"), o.setAttribute("href", "#E"), 
                    i.id = "E", o.appendChild(k), o.appendChild(l), o.appendChild(m), o.appendChild(n), 
                    i.appendChild(o), j.appendChild(i);
                    var v = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                    v.appendChild(j);
                } else {
