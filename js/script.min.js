...
=======
    var c = [], d = [], e = "";
    loadSearch("Building\\AllRooms.txt"), c = document.getElementById("arrayStore").value.split(","),
    console.log(b);
    for (var f = 0; f <= c.length - 1; f++) c[f].includes(b) && d.push(c[f]);
    console.log(d);
    for (var g = 0; g < 4 && g <= d.length - 1; g++) e += '<option value="' + d[g] + '" />';
    roomList.innerHTML = "<select>" + e + "</select>";
>>>>>>> 64c18f5... Bug Fixes
=======
>>>>>>> 03a232e... No Change
}
...
=======
>>>>>>> d1c7dc8... Fixing localstorage function
=======
>>>>>>> ffc56f6... Fixed C3 events not showing when in C3 building
=======
=======
>>>>>>> b24ecdf... Building legend and fixed C3
function buildingLegend() {
...
>>>>>>> 11499da... Safety Mode added to Min file
=======
...
=======
    if (console.log(">>>>> activateRoom started"), "4983" !== a) {
>>>>>>> 4d5a3ff... Search Suggestion Function
=======
    if (console.log(" activateRoom started"), "4983" !== a) {
...
<<<<<<< HEAD
            var n = function() {
                console.log("upperHash started"), "4983" !== b ? window.location.hash = c.toUpperCase() + b.toUpperCase() : window.location.hash = c.toUpperCase(),
=======
            switch (function() {
<<<<<<< HEAD
                console.log("upperHash started"), window.location.hash = "4983" !== b ? c.toUpperCase() + b.toUpperCase() : c.toUpperCase(),
<<<<<<< HEAD
>>>>>>> 8b39b7e...  Search function fixed, 3ed & 2end Floor html modified
=======
            switch (function() {
<<<<<<< HEAD
<<<<<<< HEAD
...
<<<<<<< HEAD
<<<<<<< HEAD
                "3" === b[0] ? (f = "B", g = "3") : "2" === b[0] ? (f = "B", g = "2") : "1" === b[0] ? (f = "B",
                g = "1") : (f = "B", g = "1");
=======
...
<<<<<<< HEAD
<<<<<<< HEAD
                "2" === b[0] ? (f = "D", g = "2") : "1" === b[0] ? (f = "D", g = "1") : (f = "D",
                g = "1");
=======
...
<<<<<<< HEAD
<<<<<<< HEAD
                "3" === b[0] ? (f = "L", g = "3") : "2" === b[0] ? (f = "L", g = "2") : "1" === b[0] ? (f = "L",
                g = "1") : (f = "L", g = "1");
=======
                "2" === b[0] ? (f = "D", g = "2") : (b[0], f = "D", g = "1");
                break;
...
<<<<<<< HEAD
<<<<<<< HEAD
    d = getMap(a.toUpperCase(), b), "" !== d && (console.log("searchNewFloor calls addMap"),
=======
...
<<<<<<< HEAD
<<<<<<< HEAD
    "" === c && "" === d && "" !== e && isLetter(a[0]) && isNumeric(a[2]) && (c = a[0],
    d = a.substring(1), e = "");
    var g = {
=======
...
=======
    }), loadFile("campusEvents", campusEventsFile).then(function(a) {}, function(a) {
>>>>>>> 8b33859... v1.8.1, Event links bug fix
=======
    }), loadFile("campusEvents", campusEventsFile).then(function(a) {
        checkLocalStorage();
...
>>>>>>> f8a24d4... More efficient event link
        console.error("Failed!", a);
>>>>>>> cdb85f9... Offline compatibility for campus event info
    });
