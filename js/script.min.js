    ...
    return new Promise(function(g, h) {
        ...
        i.open("GET", a, !0), i.onload = function() {
            if (200 !== i.status && h(Error(i.statusText)), b !== d) {
                ...
                "Campus" === b ? (hideElement(a, !0), "show" === eatCookie("legend") ? (hideElement(k, !1), 
                document.getElementById("pLegend").style.display = "inherit") : (hideElement(k, !0), 
                document.getElementById("pLegend").style.display = "none")) : (hideElement(a, !1), 
                hideElement(k, !0)), void 0 !== c ? (hideElement(e, !1), hideElement(j, !1), floorDropDown(b), 
                e.innerHTML = "FL" + c) : (hideElement(e, !0), hideElement(j, !0));
            }
...
function searchRoomNumber() {
    ...
    if ("" !== h.building && (c = h.building), "" !== h.room && (b = h.room), "" !== h.roomName) {
        ...
        switch (function() {
          ...
          case "C":
            "3" === b[1] ? "2" === b[0] ? (f = "C3", g = "2") : "1" === b[0] ? (f = "C3", g = "1") : (b[0].toUpperCase(), 
            f = "C3", g = "G") : "2" === b[0] ? (f = "C", g = "2") : (b[0], f = "C", g = "1");
            break;
...
function searchNewFloor(a, b, c) {
    ...
    alert("CurBuilding: " + e + "building"), e.innerHTML === a && f.innerHTML === b || (d = getMap(a.toUpperCase(), b), 
    "" !== d && addMap(d, a, b).then(function(a) {
