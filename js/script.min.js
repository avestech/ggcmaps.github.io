...
function visitCheck() {
    if ("" === eatCookie("visits") || null === eatCookie("visits")) cookieMold("visits", 1, 1); else {
        var a = parseInt(eatCookie("visits")) + 1;
        cookieMold("visits", a, 1), "show" === eatCookie("legend") && (document.getElementById("legendSwitch").checked = !0);
    }
}
...
function searchFromBar(a) {
    13 != a.which && 13 != a.keyCode || searchRoomNumber();
}

function searchFromMenu(a) {
    closeMenu();
    var b = parseSearch(a);
    "campus" === b.roomName.toLowerCase() ? (document.getElementById("roomSearch").value = "", 
...
function searchRoomNumber() {
    var a = document.getElementById("roomSearch").value.toUpperCase(), b = "4983", c = document.getElementById("building").innerHTML, d = c, e = document.getElementById("floor").innerHTML, f = "", g = "", h = parseSearch(a);
    if ("" !== h.building && (c = h.building), "" !== h.room && (b = h.room), "" !== h.roomName) {
        b = "";
        for (var i in roomNames) {
            var j = i;
            for (var k in roomNames[i]) {
                var l = k;
                for (var m in roomNames[i][k]) {
                    var n = roomNames[i][k][m];
                    n.name.toLowerCase() === h.roomName.toLowerCase() && (f = j, g = l, b = n.id);
                }
            }
        }
        "" === b ? alert('Were you trying to search by nickname? Unfortunately, "' + h.roomName + '" is not recognized.\nPlease check your spelling, or try a more common name.\n\nExample: Search for "Moes" not "Mo"') : window.location.hash = h.roomName;
    } else {
        var o = function() {
            "4983" !== b ? window.location.hash = c.toUpperCase() + b.toUpperCase() : window.location.hash = c.toUpperCase(), 
            clearTimeout(urlTimer);
        };
        switch (o(), c[0].toUpperCase()) {
          case "A":
            f = "A", g = void 0;
            break;

          case "B":
            "3" === b[0] ? (f = "B", g = "3") : "2" === b[0] ? (f = "B", g = "2") : (f = "B", 
            g = "1");
            break;

          case "C":
            "3" === b[1] ? "2" === b[0] ? (f = "C3", g = "2") : "1" === b[0] ? (f = "C3", g = "1") : "G" === b[0].toUpperCase() && (f = "C3", 
            g = "G") : "2" === b[0] ? (f = "C", g = "2") : "1" === b[0] && (f = "C", g = "1");
            break;

          case "D":
            "2" === b[0] ? (f = "D", g = "2") : "1" === b[0] && (f = "D", g = "1");
            break;

          case "E":
            "3" === b[0] ? (f = "E", g = "3") : "2" === b[0] ? (f = "E", g = "2") : "1" === b[0] && (f = "E", 
            g = "1");
            break;

          case "F":
            "2" === b[0] ? (f = "F", g = "2") : "1" === b[0] && (f = "F", g = "1");
            break;

          case "H":
            "3" === b[0] ? (f = "H", g = "3") : "2" === b[0] ? (f = "H", g = "2") : "1" === b[0] && (f = "H", 
            g = "1");
            break;

          case "I":
            "3" === b[0] ? (f = "I", g = "3") : "2" === b[0] ? (f = "I", g = "2") : "1" === b[0] && (f = "I", 
            g = "1");
            break;
    ...
    d !== f || e !== g ? searchNewFloor(f, g, b) : activateRoom(b, !0);
}
...
function changeFloor(a, b) {
    ...
    d.value = "", c = getMap(a, b), "" !== c && addMap(c, a, b).then(function(b) {
        window.location.hash = a, clearTimeout(urlTimer);
    }, function(a) {
        console.error("Failed!", a);
    });
}
