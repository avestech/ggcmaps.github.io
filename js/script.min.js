...
function insertEvents(a, b) {
    ...
    /[a-zA-Z]\-[A-Z|0-9][0-9]+/), g = 0; g < b; g++) {
        ...
        if (h >= c.getDate() && h <= c.getDate() + 14) {
            ...
            var t = q[0].split(" "), u = !1;
            if (1 == f.test(p)) {
                o.setAttribute("href", window.location.href.substring(0, window.location.href.search("#") + 1) + f.exec(p)), 
                o.setAttribute("onclick", "closeTab('campusEvents');"), o.appendChild(k), o.appendChild(l), 
                o.appendChild(m), o.appendChild(n), i.appendChild(o), j.appendChild(i), 1 == f.exec(p)[0].includes("C-G") ? i.id = "C3" : "C" == f.exec(p)[0].indexOf(0) && f.exec(p)[0].substr(2, 4) > 1300 && f.exec(p)[0].substr(2, 4) < 2e3 || "C" == f.exec(p)[0].indexOf(0) && f.exec(p)[0].substr(2, 4) > 2300 && f.exec(p)[0].substr(2, 4) < 3e3 ? i.id = "C3" : i.id = f.exec(p)[0].substr(0, 1);
                ...
                if (1 == u) {
                    ...
                    var v = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                    v.appendChild(j);
                } else if (q.length > 1 && 1 == q[1].includes("Building")) {
