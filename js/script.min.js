...
function insertEvents(a, b) {
    ...
    /[a-zA-Z]\-[A-Z|0-9][0-9]+/), g = 0; g < b; g++) {
        ...
        if (h >= c.getDate() && h <= c.getDate() + 14) {
            ...
            var t = q[0].split(" "), u = !1;
            if (1 == f.test(p)) {
                o.setAttribute("href", "#" + f.exec(p)[0].replace("-", "")), o.setAttribute("onclick", "closeTab('campusEvents');"), 
                ...
                if (1 == u) {
                    o.setAttribute("href", "#" + w), o.setAttribute("onclick", "closeTab('campusEvents');"), 
                    ...
                    o.setAttribute("href", "#" + q[1].substr(q[1].search("Building") + 9)), i.id = q[1].substr(q[1].search("Building") + 9), 
                    ...
                    var B = /[A-Z|0-9][0-9]+/;
                    o.setAttribute("href", "#" + q[0].substr(q[0].search("Building") + 9) + B.exec(q[1])), 
                    ...
                    o.setAttribute("href", "#E"), i.id = "E", o.setAttribute("onclick", "closeTab('campusEvents');"), 
                    o.appendChild(k), o.appendChild(l), o.appendChild(m), o.appendChild(n), i.appendChild(o), 
                    j.appendChild(i);
                    var v = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                    v.appendChild(j);
