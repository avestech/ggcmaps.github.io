...
function insertEvents(a, b) {
    ...
    /[a-zA-Z]\-[A-Z|0-9][0-9]+/), g = 0; g < b; g++) {
        ...
        if (h >= c.getDate() && h <= c.getDate() + 14) {
            ...
            j.innerText = a[g][1], i.appendChild(j);
            var k = document.createElement("p");
            k.innerText = a[g][0], i.appendChild(k);
            var l = document.createElement("p");
            l.innerText = a[g][2], i.appendChild(l);
            var m = document.createElement("p");
            if (m.innerText = a[g][3], i.appendChild(m), 1 == f.test(a[g][3])) {
                var n = document.createElement("a");
                n.setAttribute("href", window.location.href.substring(0, window.location.href.search("#") + 1) + f.exec(a[g][3])), 
                n.appendChild(i);
                var o = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                o.appendChild(n);
            } else if (0 == f.test(a[g][3]) || null == f.test(a[g][3])) {
                var o = document.querySelectorAll("div#campusEvents")[0].children[0].children[2];
                o.appendChild(i);
            }
        }
...
function checkLocalStorage() {
    ...
    null == b && null == c ? getEvents() : b[0][0].search(a.toLocaleString("en", {
        month: "long"
    })) < 0 ? getEvents() : insertEvents(b, c);
}
