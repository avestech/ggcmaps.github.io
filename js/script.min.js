...
function searchRoomNumber() {
    ...
    var a = document.getElementById("roomSearch").value.toUpperCase(), b = "4983", c = document.getElementById("building").innerHTML, d = c, e = document.getElementById("floor").innerHTML, f = "", g = "";
