...
function searchRoomNumber() {
  ...
  //alert("Building in SRN: " + building); building is campus at this point
  ...
  if (rInfo.roomName !== '') { // Search by names instead of numbers
    ...
    upperHash();
    switch (building.toUpperCase()) {//remove [0] from building.toUpper fixed C map opening when no search entered
      //alert("SRM building: " + building[0]);c building error not here
      ...
      case 'B':
        ...
        break;
      case 'C':
      //alert("Made it to case C in SRN"); case C is accessed because building si campus?
