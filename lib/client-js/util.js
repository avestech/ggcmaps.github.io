...
function parseSearch(str) {
    ...
    // Checks to see if the ground floor of W made it into roomName instead of building and room
    ...
    /* TODO remove
        Patch work for W while it is still classified as a seperate building from C
    */
